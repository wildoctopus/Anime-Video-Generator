...
Well in the current revolutionizing digital world, animated videos are making a huge impact over society. Every person irrespective of their age group loves to watch animated videos because its engaging not only in terms of entertainment but also educative. As its getting day by day popular among millennials or middle class person, still there's a part of society who cannot afford such electronic gadgets or have cable connection or subscriptions of TV channels, running such animated programs. So, this project Idea arise from this thought, to why not use Deep learning (especially, [Generative Adversarial Networks](https://arxiv.org/abs/1406.2661)) to design such model which can generate Animated Videos directly from Real time videos recorded from Mobile and make this available to every class of society. 
